...
const SongSchema = new import_mongoose.default.Schema({
  title: String,
  artist: String,
  albumArt: String
});
const PlaylistSchema = new import_mongoose.default.Schema({
  ...
  songIds: [{ type: import_mongoose.default.Schema.Types.ObjectId, ref: "Song" }]
});
const Playlist = import_mongoose.default.model("Playlist", PlaylistSchema);
